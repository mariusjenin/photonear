...
** main       = type (wn: window, pb: pbuffer, wp: window & pbuffer, bm: bitmap)
...
VisualInfoARB (GLContext* ctx)
{
  ...
  if (!verbose)
  {
    ...
    fprintf(file, " |  id | main ac gd fm db sw st ms |  sz  r  g  b  a | bf th cl |  sz  r  g  b  a | ov un sw |\n");
    fprintf(file, " +-----+-------------------------+-----------------+----------+-----------------+----------+\n");
...
VisualInfoGDI (GLContext* ctx)
{
  ...
  if (!verbose)
  {
    ...
    fprintf(file, " id  dep main sp sz  l  ci b ro ne ac sz sz sz sz bf th cl  sz  r  g  b  a ns b\n");
    fprintf(file, "-----------------------------------------------------------------------------\n");
...
VisualInfo (GLContext* ctx)
{
  ...
  if (fbc)
  {
    if (!verbose)
    {
      ...
      fprintf(file, " |  id | main xr cl fm db st lv xp |  sz  r  g  b  a | bf th cl | r  g  b  a  | ns  b |  eat |\n");
      fprintf(file, " +-----+-------------------------+-----------------+----------+-------------+-------+------+\n");
