...
void CornellBox::init_scene_graph() {
    ...
    auto spot_light1 = make_shared<SpotLightMaterial>(texture_manager->get_and_increment_id_texture(), make_shared<TextureColor>(spot_intensity),25,45,700, 0.02f,0.f,0.01f);
    auto spot_light2 = make_shared<SpotLightMaterial>(texture_manager->get_and_increment_id_texture(), make_shared<TextureColor>(spot_intensity),25,45,700, 0.02f,0.f,0.01f);
    auto spot_light3 = make_shared<SpotLightMaterial>(texture_manager->get_and_increment_id_texture(), make_shared<TextureColor>(spot_intensity),25,45,700, 0.02f,0.f,0.01f);
    auto spot_light4 = make_shared<SpotLightMaterial>(texture_manager->get_and_increment_id_texture(), make_shared<TextureColor>(spot_intensity),25,45,700, 0.02f,0.f,0.01f);
